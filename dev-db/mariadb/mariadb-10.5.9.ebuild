...
src_prepare() {
	rm -v "${WORKDIR}"/mariadb-patches/0007-MDEV-19838-followup-to-make-happy-following-protocol.patch
	rm -v "${WORKDIR}"/mariadb-patches/0008-MDEV-24096-InnoDB-assertion-first_free-srv_page_size.patch
