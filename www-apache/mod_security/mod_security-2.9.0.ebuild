...
# $Header: /var/cvsroot/gentoo-x86/www-apache/mod_security/mod_security-2.7.7.ebuild,v 1.1 2014/10/03 18:15:58 flameeyes Exp $
...
src_prepare() {
	cp "${FILESDIR}"/modsecurity-2.9.conf "${T}"/79_modsecurity.conf || die
}
